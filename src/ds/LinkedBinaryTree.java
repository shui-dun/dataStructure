...
public class LinkedBinaryTree<E> extends AbstractBinaryTree<E> {
    ...
    @Override
    public Position<E> parent(ds.Position<E> treeNode) throws IllegalArgumentException {
        return validate(treeNode).getParent();
    }

    @Override
    public Position<E> left(ds.Position<E> treeNode) throws IllegalArgumentException {
        return validate(treeNode).getLeft();
    }

    @Override
    public Position<E> right(ds.Position<E> treeNode) throws IllegalArgumentException {
    ...
    public Position<E> addLeft(ds.Position<E> p, E e) throws IllegalArgumentException {
    ...
    public Position<E> addRight(ds.Position<E> p, E e) throws IllegalArgumentException {
        Node<E> parent = validate(p);
    ...
    public E set(ds.Position<E> p, E e) throws IllegalArgumentException {
    ...
    public void attach(ds.Position<E> p, LinkedBinaryTree<E> tree1, LinkedBinaryTree<E> tree2) throws IllegalArgumentException {
        Node<E> node = validate(p);
        if (isInternal(p)) {
            throw new IllegalArgumentException();
        }
    ...
    public E remove(ds.Position<E> p) throws IllegalArgumentException {
        Node<E> node = validate(p);
        if (numChildren(p) == 2) {
            throw new IllegalArgumentException();
        }
